...
- and once in the end when it goes idle and there are no callbacks to be executed then it waits at poll phase as most of the callbacks are executed at I/O callbacks
