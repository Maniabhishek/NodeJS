...
- before nodejs, js was only able to run on browser , and on browser it was able to run because of js engine , that js engine was v8 on chrome and spider monkey on firefox
