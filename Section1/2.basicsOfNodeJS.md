...
-  (link) when we tried executing function calculateSum function from sum file by just using require method we saw it was not executed but the first line of console log was executed
