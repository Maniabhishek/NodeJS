...
- as you see in the above output , setImmediate executed after fileRead, it will happen when there is nothing in the file and immediately gets ready before it reaches setImmediiate phase 
- but if there is something in the file then setImmediate will get executed first
