...
console.log(b)
```
 -  the above code execution when tries to access b outside the function a then fec in which b would have created must have been removed when it reached to this line (printing b) then there is no variable b in memory
