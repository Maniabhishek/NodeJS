...
- and then create a retry method which takes function as argument and keeps calling the previous function (which returns the promise) for n number of times 
